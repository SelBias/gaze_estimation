...
def correlated_precision_without_val(
    ...
    reset_opt=True, betas=(0.9, 0.999)) : 
    ...
    np.save(f'./prediction/corr_prec_{experiment_name}_pred_adjusted', prediction_adjusted)
    ...
    np.save(f'./prediction/corr_prec_{experiment_name}_w', w_list)
