...
def hetero_precision_without_val(
    ...
    precision   = precision_module(p, K, init_log_lamb, device=device).to(device)
    ...
    torch.save(mean_model.state_dict(), f'./Model/hetero_prec_{experiment_name}_pretrained_mean_model.pt')
    torch.save(log_phi_layer.state_dict(), f'./Model/hetero_prec_{experiment_name}_pretrained_variance_model.pt')
    torch.save(precision.state_dict(), f'./Model/hetero_prec_{experiment_name}_pretrained_precision.pt')
    ...
    np.save(f'./Prediction/hetero_prec_{experiment_name}_train_loss', train_loss_list)
    np.save(f'./Prediction/hetero_prec_{experiment_name}_test_loss', test_loss_list)
    np.save(f'./Prediction/hetero_prec_{experiment_name}_v_list', v_list_list)
    np.save(f'./Prediction/hetero_prec_{experiment_name}_precision', precision_list)
    np.save(f'./Prediction/hetero_prec_{experiment_name}_beta', beta_list)
    np.save(f'./Prediction/hetero_prec_{experiment_name}_w', w_list)
    np.save(f'./Prediction/hetero_prec_{experiment_name}_train_Gamma', train_Gamma_list_list)
    np.save(f'./Prediction/hetero_prec_{experiment_name}_test_Gamma', test_Gamma_list_list)

    torch.save(mean_model.state_dict(), f'./Model/hetero_prec_{experiment_name}_trained_mean_model.pt')
    torch.save(best_nhll_mean_model.state_dict(), f'./Model/hetero_prec_{experiment_name}_nhll_selected_mean_model.pt')
    
    torch.save(log_phi_layer.state_dict(), f'./Model/hetero_prec_{experiment_name}_trained_variance_model.pt')
    torch.save(best_nhll_log_phi_layer.state_dict(), f'./Model/hetero_prec_{experiment_name}_nhll_selected_variance_model.pt')
    
    torch.save(precision.state_dict(), f'./Model/hetero_prec_{experiment_name}_trained_precision.pt')
    torch.save(best_nhll_precision.state_dict(), f'./Model/hetero_prec_{experiment_name}_nhll_selected_precision.pt')
