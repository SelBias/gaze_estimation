...
def hetero_precision_without_val(
    ...
    normalize=True, deg=True, test_unseen=False, weighted=True, verbose=True, large_test=False, betas=(0.9, 0.999)) : 
    ...
    for iter in tqdm(range(pretrain_iter)) : 
        ...
        mean_model.eval()
        with torch.no_grad() : 
            # Evaluation 1 : random effect adjustment (outdated)
            ...
            # Evaluation 2 : Train MAE / MSE / NHL
    ...
    for iter in tqdm(range(max_iter)) : 
        ...
        with torch.no_grad() : 
            ...
            print(f'{iter}-th main train train MAE, MSE, NHL : {train_mae:.4f} deg, {train_mse:.4f}, {train_nhll:.4f}')
            ...
            if test_unseen is True : 
                ...
                print(f'{iter}-th main train test MAE, MSE, NHL : {test_mae:.4f} deg, {test_mse:.4f}, {test_nhll:.4f}')
        ...
        if nhll_update_count == patience :
            ...
            print(f"Main train may be stopped at {iter-patience}th iter based on Train NHL")
    ...
    if test_unseen is True : 
        print(f'NHLL-selected model train MAE, MSE, NHL : {train_loss_list[0,best_nhll_index]:.4f} deg, {train_loss_list[1,best_nhll_index]:.4f},  {train_loss_list[4,best_nhll_index]:.4f}')
        print(f'NHLL-selected model test MAE, MSE : {test_loss_list[0,best_nhll_index]:.4f} deg, {test_loss_list[1,best_nhll_index]:.4f}')
        
    else : 
        print(f'NHLL-selected model train MAE, MSE, NHL : {train_loss_list[0,best_nhll_index]:.4f} deg, {train_loss_list[1,best_nhll_index]:.4f},  {train_loss_list[4,best_nhll_index]:.4f}')
        print(f'NHLL-selected model test MAE, MSE, NHL : {test_loss_list[0,best_nhll_index]:.4f} deg, {test_loss_list[1,best_nhll_index]:.4f}, {test_loss_list[4,best_nhll_index]:.4f}')
